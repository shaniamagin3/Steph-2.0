...
export const INGREDIENTS = [
  ...
  I('salmon_fillet', 'Salmon fillet (raw)', 'Meat & seafood', 100, 'g', 208, 20, 0, 13, 0, { tags: ['animal', 'omega3'] }),
  I('white_fish', 'White fish fillet (barramundi / cod)', 'Meat & seafood', 100, 'g', 92, 20, 0, 1, 0, { tags: ['animal'] }),
  I('prawns', 'Prawns (raw, peeled)', 'Meat & seafood', 100, 'g', 85, 18, 0.9, 1, 0, { tags: ['animal'] }),
  I('tuna_canned', 'Tuna in springwater (drained)', 'Pantry', 100, 'g', 116, 26, 0, 1, 0, { tags: ['animal', 'pantry-staple'] }),
  I('salmon_smoked', 'Smoked salmon', 'Meat & seafood', 100, 'g', 142, 22, 0, 6, 0, { tags: ['animal', 'omega3'] }),
